...
@app.cls(
    image=image,
    gpu="A10G",
    container_idle_timeout=300, # Keep it running for 5 mins after last use
...
def keep_warm():
    health_url = "https://tinaf2--sd-demo-model-health.modal.run"
    generate_url = "https://tinaf2--sd-demo-model-generate.modal.run"
